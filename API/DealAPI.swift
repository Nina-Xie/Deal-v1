...
class DealAPI {
    ...
    static func getUser() -> User {
        let user = User(userName: "Nina", profileImageName: "UserProfile", personalInformation: "Hi! If you're interested, contact me at xxx@cornell.edu :)")
        return user
    }
    
    static func getComment() -> [Comment] {
        let comments = [
            Comment(userName: "Nina", message: "This is useful"),
            Comment(userName: "Yichen", message: "Hello I'm wondering what the dimensions of this item are"),
            Comment(userName: "Joyce", message: "How long have you been using it?"),
            Comment(userName: "Xiangyi", message: "It looks great! Why did you decided to sell it? How should I contact you? Is the price you proposed fixed? Can you show more pictures of the item?")
        ]
        return comments
    }
}
